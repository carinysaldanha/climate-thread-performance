...
public class WeatherFetcher {
    ...
    public static WeatherData fetch(City city) {
        try {
            ...
            String url = String.format("%s?latitude=%.2f&longitude=%.2f&start_date=2024-01-01&end_date=2024-01-31&hourly=temperature_2m",
            ...
            for (int i = 0; i < timestamps.length(); i++) {
                String data = timestamps.getString(i).substring(0, 10); // pega apenas "YYYY-MM-DD"
